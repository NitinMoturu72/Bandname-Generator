...
app.post("/submit", (req, res) => {
  ...
  const rand_1 = Math.floor(Math.random() * adj.length);
  const rand_2 = Math.floor(Math.random() * noun.length);
  var select_Adj = adj[rand_1];
  var select_Noun = noun[rand_2];
  var bandName = select_Adj + " " + select_Noun;
